...
Sub CrearDashboardSpreadsCP()
    ...
    For m = 0 To 2
        ...
        Resumen ws, r0, m, mets(m), "$AF$" & (m + 1), sPI, sPF, rats
    Next m
...
Private Sub Resumen(ws As Worksheet, r0 As Long, m As Long, nm As String, fc As String, _
                    sPI As String, sPF As String, rats As Variant)
...
Private Sub Puntos(ws As Worksheet, cX As Long, celEmi As String, sPF As String, nm As String, fc As String)
